...
class DANN_Network(pl.LightningModule):
    def __init__(self, max_epochs, batch_size, seg_metric):
        super().__init__()
        self.lr = 1e-3
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('Binary Cross Entropy Loss - Training', err_mask_source, prog_bar=True)
        ...
        self.log('Error Domain Summed - Training', err_domain_source+err_domain_target, prog_bar=True)
        self.log('Total Loss - DANN Training', loss, prog_bar=True)

...
def main_DANN(hparams: Namespace):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, choices=["w/o_DA", "DANN"], help="Name of the model which is used for training, FDA: Fourier Domain Adaptation")

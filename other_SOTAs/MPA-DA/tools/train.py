...
POWER = 0.9
INPUT_SIZE = (256, 256)
SOURCE_DATA = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/CVC-EndoScene'
TRAIN_SOURCE_LIST = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/CVC-EndoScene/train.txt'
TEST_SOURCE_LIST = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/CVC-EndoScene/test.txt'

TARGET_DATA = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/ETIS-LaribPolypDB'
TRAIN_TARGET_LIST = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/ETIS-LaribPolypDB/valid.txt'
TEST_TARGET_LIST = '/home/Maack/master_thesis/datasets/content/drive/MyDrive/Master_Thesis/datasets/PolypDatasets/ETIS-LaribPolypDB/test.txt'
...
def main():
    ...
    for epoch in range(args.num_steps):
        ...
        for i_iter, batch in enumerate(train_loader):
            ...
            label_target = data_target['label'].cuda()

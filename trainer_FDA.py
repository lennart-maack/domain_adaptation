...
from models.FDA import FDA_first_train, UNet_baseline
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, choices=["FDA", "UNet_baseline"], help="Name of the model which is used for training, FDA: Fourier Domain Adaptation")
